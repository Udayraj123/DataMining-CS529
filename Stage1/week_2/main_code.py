...
print("Running Floyd Warshall for closeness (This may take time)")
...
compareDirect(eigenvector_centrality,list(nx.eigenvector_centrality(subG,weight='weight').values()),write="eigenvector")#,size=subSize)
